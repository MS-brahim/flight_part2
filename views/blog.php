...
<?php include_once "parts/navbar.php"?>
    <div class="container">
        ...
        <div id="myBtnContainer">
            ...
            <button class="btn" onclick="filterSelection('aeroport')"> Aéroport</button>
        ...
        <div class="row">
            <div class="column aeroport">
                <div class="content">
                    <img src="assets/airplane.jpg" alt="Mountains" style="width:100%">
                    <h4>Mountains</h4>
            ...
            <div class="column flight">
                <div class="content">
                    <img src="assets/airplane.jpg" alt="Lights" style="width:100%">
                    <h4>Lights</h4>
                    <p>Lorem ipsum dolor..</p>
                </div>
            </div>
            <div class="column services">
                <div class="content">
                    <img src="assets/airplane.jpg" alt="Nature" style="width:100%">
                    <h4>Forest</h4>
                    <p>Lorem ipsum dolor..</p>
                </div>
            </div>
